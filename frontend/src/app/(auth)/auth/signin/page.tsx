...
export default function SignInPage() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#efe7ff] px-6 py-10 text-zinc-900 sm:px-10 sm:py-12">
      <div className="absolute inset-x-0 top-0 h-20 bg-[#6d3ed3] sm:h-24" aria-hidden="true" />

      <div className="relative mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-xl items-center justify-center py-8 sm:min-h-[calc(100vh-6rem)]">
        <div className="w-full space-y-8">
          <div className="space-y-3 text-center">
            <h1 className="text-4xl font-semibold tracking-tight text-zinc-950 sm:text-5xl">Welcome!</h1>
            <p className="text-base text-zinc-700 sm:text-lg">Login to Proceed</p>
          </div>
          ...
          <p className="text-center text-sm text-zinc-700">
            ...
            <Link href="/auth/signup" className="font-medium text-zinc-900 underline underline-offset-2">
              Create one
            </Link>
          </p>
        </div>
